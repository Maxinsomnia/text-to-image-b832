...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-image-b832
```

A live public deployment of this template is available at [https://text-to-image-b832.templates.workers.dev](https://text-to-image-b832.templates.workers.dev)
